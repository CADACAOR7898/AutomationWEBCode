...
public class LoginStepsDef {
    ...
    public void agrego_un_item_al_carrito_de_compras() {
        ...
        inventorySteps.addCart();
        System.out.println("Se agrego un producto al carrito");
        screenShot();
    }
    ...
    public void reviso_que_el_carrito_de_compras_tenga_un_item_agregado() {
        InventorySteps inventorySteps = new InventorySteps(driver);
        inventorySteps.cart();
        System.out.println("Reviso que el carrito de compras tenga un item agregado");
        screenShot();
    }

    @Y("valido que el item agregado se llame {string}")
    public void valido_que_el_item_agregado_se_llame(String expectedNameItem) {
        String name =  cartSteps(driver).getNameItem();
        //prueba: validamos que el producto selecionado se encuentre en el carrito
        System.out.println("Valido que el item agregado se llame " + name);
        Assertions.assertEquals(expectedNameItem, name);
    }
